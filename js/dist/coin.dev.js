...
Coin.prototype.draw2 = function (canvas) {
  var context = canvas.getContext('2d');
  context.fillStyle = 'rgb(255, 254, 254)';
  context.fillRect(this.x, this.y, this.w, this.h); // context.drawImage(this.image, this.x, this.y, this.w, this.h)
};
...
function isEnemyHitHero(obj1, obj2) {
  ...
  if (minX < maxX && minY < maxY) {
    console.log('吃到金币'); // var cSound = new Audio('./music/getCoin.mp3')
    // bSound.play()
